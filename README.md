...
Just download the executable `manc_cojo` for immediate use on 64-bit Linux system [Click here](https://github.com/light156/multi-ancestry-COJO/releases/download/v1.0.0/manc_cojo). 
