...
For example, for the trait high-density lipoprotein (HDL) cholesterol with ~6.5 million SNPs and ~76,000 individuals, the per-chromosome running time of our program (using 1 thread) and GCTA (using 5 threads), is as follows. 
