...
{   
    ...
    app.add_option("--extract", params.extract_file, "File path of SNPs to be included")->group(data_group);
    app.add_option("--exclude", params.exclude_file, "File path of SNPs to be excluded")->group(data_group);
