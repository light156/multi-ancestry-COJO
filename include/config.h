...
struct HyperParams {
    double p_value = 5e-8;
    double fix_p_value = 5e-8;
    double collinear = 0.9;
    double fix_collinear = 0.9;
    double fix_cojo_collinear = 0.9;
    vector<double> maf_sumstat_list, maf_list, missingness_list, diff_freq_list;
    ...
    bool if_fix_drop = false;
    bool if_var_from_ld = false;
    bool if_hetero_report = false;
